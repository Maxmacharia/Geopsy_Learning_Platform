        ...
        <div className="card-raised p-8">
          ...
          <div className="relative my-5">
            ...
            <div className="relative text-center">
              <span className="text-xs text-muted bg-surface px-3">or continue with</span>
            </div>
          </div>
          ...
          <p className="text-center text-sm text-muted mt-5">
            ...
            <Link to="/register" className="text-ring font-semibold hover:underline">Register free</Link>
          </p>
        </div>
      </div>
    </div>
